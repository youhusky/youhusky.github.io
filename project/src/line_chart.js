...
var color = d3.scale.ordinal().range(["#48A36D", "#56AE7C", "#64B98C", "#72C39B", "#80CEAA", "#80CCB3", "#7FC9BD", "#7FC7C6", "#7EC4CF", "#7FBBCF", "#7FB1CF", "#80A8CE", "#809ECE", "#8897CE", "#8F90CD", "#9788CD", "#9E81CC", "#AA81C5", "#B681BE", "#C280B7", "#CE80B0", "#D3779F", "#D76D8F", "#DC647E", "#E05A6D", "#E16167", "#E26962", "#E2705C", "#E37756", "#E38457", "#E39158", "#E29D58", "#E2AA59", "#E0B15B", "#DFB95C", "#DDC05E", "#DBC75F", "#E3CF6D", "#EAD67C", "#F2DE8A",
    '#1f77b4',
    '#aec7e1', '#ff7f0e', '#f9d5e5', '#eeac99', '#e06377', '#c83349', '#5b9aa0', '#d6d4e0', '#b8a9c9', '#622569', '#ffcc5c', '#588c7e', '#c7c7c7',
    '#f2ae72', '#c83349', '#667292', '#9edae5'
]);
...
var svg = d3.select("#line_chart_new").append("svg")
...
d3.csv("src/motordata.csv", function(error, data) {
    ...
    var categories = color.domain().map(function(name) { // Nest the data into an array of objects with new keys
        return {
            ...
            visible: (name === "U.S. " ? true : false) // "visible": all false except for economy which is true.
        };
    });
    ...
    context.append("g")
        ...
        .attr("fill", "#E6E7E8");
    context.append('text').attr('x', -36).attr('y', 30).text("Select Years");
    //end slider part-----------------------------------------------------------------------------------
    ...
    // draw legend
    var legendSpace = 520 / categories.length; // 450/number of issues (ex. 40)    
